...
public class FileUtils {
    ...
    public static MultipartFile createImg(String url) {
        try {
            ...
            MultipartFile multipartFile = null;//new MockMultipartFile(file.getName(), inputStream);
    ...
    public static MultipartFile fileToMultipart(String filePath) {
        try {
            ...
            FileInputStream inputStream = new FileInputStream(file);
            MultipartFile multipartFile = null;// new MockMultipartFile(file.getName(), "png", "image/png", inputStream);
            return multipartFile;
        } catch (IOException e) {
